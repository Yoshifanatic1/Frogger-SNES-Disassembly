; Note: Put your custom routine/data macros, references to them, and defines in this file from within the FROGGER_InsertIntegratedPatches and FROGGER_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro FROGGER_InsertIntegratedPatches()
...
macro FROGGER_ApplyPatchesPostAssembly()
